...
<div class="form-group">
    ...
    <div id="categories">
        @foreach ($categoryData as $category)
            <div>
                <input type="radio" name="trade_{{ $category->id }}" id="cat{{ $category->id }}" onchange="handleCheckboxChange('{{ $category->select_id }}', '{{ $category->id }}')" class="category-checkbox" name="category" value="{{ $category->id }}">
