...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('translate.Editing') }}  -  <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled tooltip">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16">
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('events.show.single', $event->id) }}" target="_blank"  class="btn btn-primary btn-sm">{{ __('translate.Views') }}</a></td>
                                            <td><a href="{{ route('admin.events.edit', $event->id) }}" class="btn btn-info btn-sm">{{ __('translate.Edit') }}</a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" style="background-color: #00a2e8; border-color: #008ec4; color: #fff;" data-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
