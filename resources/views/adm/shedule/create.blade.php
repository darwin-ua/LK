                        ...
                        @csrf
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal" style="background-color: #00a2e8; border-color: #008ec4; color: #fff;">{{ __('translate.Select date') }}</button>
                                    </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color: #00a2e8; border-color: #008ec4; color: #fff;">{{ __('translate.Close') }}</button>
                                                    <button type="button" class="btn btn-primary" id="saveChangesBtn" style="background-color: #00a2e8; border-color: #008ec4; color: #fff;">{{ __('translate.Save changes') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModalTimeStartEndModal" style="background-color: #00a2e8; border-color: #008ec4; color: #fff;">{{ __('translate.Select time') }}</button>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" id="saveChangesBtnTime" style="background-color: #00a2e8; border-color: #008ec4; color: #fff;">{{ __('translate.Save changes') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
