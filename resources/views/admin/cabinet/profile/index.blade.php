                    ...
                    />
                        ...
                        <div class="department-contacts">
                            ...
                            <div class="department-column">
                                            ...
                                            <div class="department-card-header">
                                                ...
                                                <div class="department-card-info">
                                                    ...
                                                    <p class="department-card-subtitle">
                                                        {{ $partnerManager->manager_name ?: 'Менеджер не вказаний' }}
                                                    </p>
                                ...
                                {{ $partnerManager->phone }}
                            </span>
                                                    </div>
                                                @endif

                                                @if(!empty($partnerManager->email))
                                                    <div class="contact-item">
                                                        <img
                                ...
                                {{ $partnerManager->email }}
                                                ...
                                                @if(empty($partnerManager->phone) && empty($partnerManager->email))
                                                    <div class="contact-item">
                            <span class="contact-text">
                                Контакти менеджера поки не заповнені
                            </span>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="department-card">
                                            <div class="department-card-header">
                                                <div class="department-card-info">
                                                    ...
                                                    <p class="department-card-subtitle">
                                                        Менеджер для вашого акаунта ще не призначений
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
