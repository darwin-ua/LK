            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Оплати від дилера       <span class="d-inline-block" tabindex="0"
                                                                                   data-toggle="tooltip"
                                                                                   title="Disabled tooltip"><form action="{{ route('admin.exportPayments') }}" method="POST">
    @csrf
    <input type="hidden" name="payments" value="{{ json_encode($payments) }}">
    <button type="submit" class="btn btn-success">В Excel
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" class="bi bi-file-earmark-spreadsheet" viewBox="0 0 16 16">
...
<section class="content" style="margin-top: -60px;">
    ...
    <div class="refresh-button">
        <a href="#" id="refreshButton" class="btn btn-warning d-flex align-items-center">
            <svg id="refreshIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
                                        ...
                                        <td>
                                            <div class="tooltip-container">
                                                @if ($payment['СтатусОплаты'] == '0' OR empty($payment['СтатусОплаты']))
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="red" class="bi bi-x-lg icon-with-tooltip" viewBox="0 0 16 16">
                                                ...
                                                @elseif ($payment['СтатусОплаты'] == '1')
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="green" class="bi bi-check-lg icon-with-tooltip" viewBox="0 0 16 16">
