...
<script>
    const tabKey = "{{ request()->path() }}"; // например sklad/orders/dop
    const storageKey = `scannedBarcodes_${tabKey}`;
</script>
<script>
